...
public class SupportMapFragment extends AppCompatActivity
...
//        }
    ...
    public void onExplanationNeeded(final List<String> permissionsToExplain) {
        Toast.makeText(this, "Please enable location to use map features", Toast.LENGTH_LONG).show();
    }
    ...
    public void onPermissionResult(final boolean granted) {
        if (granted) {
            ...
            Toast.makeText(this, "You need to enable location permissions to use map features", Toast.LENGTH_LONG).show();
